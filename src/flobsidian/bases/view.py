...
class View:
    ...
    def gather_files(self, vault):
        ...
        files = [FileInfo(f, Singleton.indices[vault].path) for f in files]
    ...
    def make_view(self, vault):
        ...
        if problems:
            ...
            add_message('problems during base rendering', 1, vault,
                        '\n'.join(problems), use_log = use_log)
