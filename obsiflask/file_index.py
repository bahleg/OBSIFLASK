...
class FileIndex:
    ...
    def refresh(self):
        ...
        self._files = [
            f for f in self._files if not any(part.startswith(".") for part in f.parts)
        ]  # ignore hidden
        ...
        AppState.hints[self.vault].string_all_file_index.update_index(files_to_add)
